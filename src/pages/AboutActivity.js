...
export default function AboutActivity() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setIsLoading(true);
            try {
                const request = await axios.get("https://api.github.com/users/ForestoAY");
                ...
                <div className="container-about">
                    <div className="about-profile">
                        ...
                        <div className="container-button">
                            <a href="https://steamcommunity.com/profiles/76561198809590745/" target="_blank" rel="noreferrer">
                                <FaSteam size="50px" />
                            </a>
                            <a href={data.html_url} target="_blank" rel="noreferrer">
                                <FaGithub size="50px" />
                            </a>
                            <a href="https://www.instagram.com/foresto_andreanyudha/" target="_blank" rel="noreferrer">
